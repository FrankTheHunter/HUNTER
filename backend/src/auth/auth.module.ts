...
import { UsersService } from '../users/users.service'; // Importation du service d'utilisateurs
import { UsersModule } from '../users/users.module'; // Importation du module d'utilisateurs
...
@Module({
  imports: [
    UsersModule, // Importation du module d'utilisateurs
    JwtModule.register({
  ...
  providers: [
    ...
    UsersService, // Déclaration du service d'utilisateurs
  ],
})
